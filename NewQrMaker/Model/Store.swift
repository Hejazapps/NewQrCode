                ...
                case .success(let receipt):
                    ...
                    case .purchased(let expiryDate, let items):
                        ...
                        if expiryDate > Date() {
                            ...
                            for item in items {
                                ...
                                print("my item are \(item.productId)")
                                
                                let productId = item.productId
                                
                                if productId.containsIgnoringCase(find: "OneTime") {
                                    print("it has been called for sure")
                    ...
                    case .expired(let expiryDate, let items):
                        ...
                        for item in items {
                            ...
                            if productId.containsIgnoringCase(find: "OneTime") {
                                print("it has been called for sure")
                                UserDefaults.standard.set(false, forKey: "OneTime")
