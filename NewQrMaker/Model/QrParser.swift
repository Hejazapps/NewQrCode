            ...
            if let  mailToURL = URL(string: txtAppend!)
            {
                if let emailParameters = EmailParameters(url: mailToURL) {
                    ...
                    if let subject1 = emailParameters.subject
                    {
                        ...
                        array[2] = "Subject:".localize() + " " + subject1
                    }
                    if let body1 = emailParameters.body
                    {
                        
                        array[3] =  "Body:".localize() + " " + body1
                    }
        ...
        if text.containsIgnoringCase(find: "MECARD") {
            ...
            for item in maV {
                if(item.containsIgnoringCase(find:MeCardCostant.KEY_NAME)) {
                    ...
                    if name.count == 1 {
                        array[0] = "First Name:".localize()
                        
                        array[0] = "First Name:".localize()  + " " + name[0]
                        ...
                        array[0] = "First Name:".localize() + " "
                        array[1] = "Last Name:".localize() + " "
                        
                        array[0] = "First Name:".localize() + " " + name[1]
                        array[1] = "Last Name:".localize() + " " +  name[0]
                ...
                if(item.containsIgnoringCase(find:MeCardCostant.KEY_TELEPHONE)) {
                    ...
                    array[2] =  "Phone Number:".localize() + " "
                    if parsed.count >= 1 {
                        array[2] =  "Phone Number:".localize() + " " + parsed
                    }
                ...
                if(item.containsIgnoringCase(find:MeCardCostant.KEY_EMAIL)) {
                    ...
                    array[3] =  "Email:".localize() + " "
                    if parsed.count >= 1 {
                        
                        array[3] =  "Email:".localize() + " " + parsed
                    }
                ...
                if(item.containsIgnoringCase(find:MeCardCostant.KEY_URL)) {
                    ...
                    array[4] =  "Url:".localize() + " "
                    
                    if parsed.count >= 1 {
                        array[4] =  "Url:".localize() + " "  + parsed
                    }
                ...
                if(item.containsIgnoringCase(find:MeCardCostant.KEY_NICK_NAME)) {
                    ...
                    array[5] =  "NickName:".localize() + " "
                    if parsed.count >= 1 {
                        array[5] =  "NickName:".localize() + " " + parsed
                    }
                ...
                if(item.containsIgnoringCase(find:MeCardCostant.KEY_ADDRESS)) {
                    ...
                    array[6] =  "Address:".localize() + " "
                    if parsed.count >= 1 {
                        array[6] =  "Address:".localize() + " " + parsed
                    }
                ...
                if item.containsIgnoringCase(find:MeCardCostant.KEY_ORG) {
                    ...
                    array[7] =  "Organization:".localize() + " "
                    
                    if parsed.count >= 1 {
                        array[7] =   "Organization:".localize() + " " + parsed
                    }
                ...
                if item.containsIgnoringCase(find:MeCardCostant.KEY_NOTE) {
                    ...
                    array[8] =  "Note:".localize() + " "
                    if parsed.count >= 1 {
                       
                        array[8] =   "Note:".localize() + " " + parsed
                    }
                }
                ...
                if item.containsIgnoringCase(find:MeCardCostant.KEY_DAY) {
                    ...
                    array[9] = "Birthday:".localize() + " "
                    if parsed.count >= 1 {
                       
                        array[9] = "Birthday:".localize() + " "  + parsed
                    }
            ...
            if let valu  =  ar {
                for item in valu {
                    ...
                    if index == 0, let x = a {
                        ...
                        if let x = a {
                            value1 = value1 + "\n\n"
                            value1 = value1 + "Latitude:".localize() + x
                        }
                    }
                    index = index + 1
                }
           ...
           var phoneValue = "Phone Number:".localize() + " "
           ...
           if let postalAddresses = contact?.postalAddresses {
               ...
               var address2 = "State:".localize() + " "
               for add in postalAddresses{
                   address2 = address2 +  add.value.state
                   address2 = address2 + " "
               }
               
               var address3 = "Country:".localize() + " "
               for add in postalAddresses{
                   address3 = address3 +  add.value.country
                   address3 = address3 + " "
               }
               
               var address4 = "Postal Code:".localize() + " "
               for add in postalAddresses{
           ...
           var urlValue = "Url:".localize() + ""
            ...
            if let orginization = contact?.organizationName
            {
                if orginization.count > 0 {
                    ...
                    var test = "Organization:".localize()
                    array[4] = "Organization:".localize() + orginization
                }
                else {
                    array[4] = "Organization:".localize()
                }
            }
           ...
           {
               if JobTitle.count > 0 {
                   var test = "JobTitle:".localize()
                   array[5] = "JobTitle:".localize() + JobTitle
               }
               else {
                   array[5] = "Job Title:".localize()
               }
           }
            ...
            if let familyname  = contact?.familyName
            {
                if familyname.count > 0 {
                    ...
                    var test = "Last Name:".localize()
                    array[1] = "Last Name:".localize() + " " + familyname
                }
                else {
                    array[1] = "Last Name:".localize()
                }
            ...
            if let firstName  = contact?.givenName
            {
                if firstName.count > 0 {
                    array[0] = "First Name:".localize() + " " + firstName
                }
                else {
                    array[0] = "First Name:".localize()
                }
            ...
            var index = 0
            var phoneNumber = "\("Phone Number".localize())          :  "
            var textValue = ""
            while text[index] != ":" {
                index = index + 1
            }
            ...
            if let  mailToURL = URL(string: txtAppend!) {
                if let emailParameters = EmailParameters(url: mailToURL) {
                    if emailParameters.toEmails.count > 0 {
                        ...
                        nameValue = "\("Email".localize())          :   " + name.replacingOccurrences(of: "Email: ", with: "")
                    }
            ...
            var  output  = ""
            var test = "Phone Number".localize()
            var test1 = "Sms".localize()
            output =  "\(test)   :  " + phoneNumber
            output = output + "\n\n"
            output =  output + "\(test1)                 :  " + textValue
            ...
            array[0] =  "Name:".localize()
            if let eventName = calendarValue.events[0].eventSummary
            {
                array[0] =  "Name:".localize() + " " + eventName
            }
            
            array[1] = "Location".localize()
            if let eventLocal = calendarValue.events[0].eventLocation
            {
                array[1] =  "Location".localize() + ":"  + eventLocal
            }
            
            array[2] =  "Note:".localize()
            if let eventNote = calendarValue.events[0].eventDescription
            {
                array[2] =  "Note:".localize() + " " + eventNote
            }
            array[3] =  "Event Start Day:".localize()
            if let eventNote = calendarValue.events[0].eventStartDate {
                
                array[3] =  "Event Start Day:".localize() + " " + eventNote.asString(style: .full)
            }
            
            array[4] =  "Event End Day:".localize()
            if let eventNote = calendarValue.events[0].eventEndDate {
                array[4] =  "Event End Day:".localize() + " " + eventNote.asString(style: .full)
            }
            ...
            if text.containsIgnoringCase(find: "WIFI") {
                ...
                var ar = text.components(separatedBy: ";")  as? NSArray ?? NSArray()
                    ...
                    if mal.containsIgnoringCase(find: "T:") {
                        ...
                        array[2] = "\("Encryption:".localize())    " +  mal.replacingOccurrences(of: "T:", with: "", options: .literal, range: nil)
                    }
                    
                    if mal.containsIgnoringCase(find: "S:") {
                        
                        array[0] = "\("Network Name:".localize())" +  mal.replacingOccurrences(of: "S:", with: "", options: .literal, range: nil)
                    }
                    if mal.containsIgnoringCase(find: "P:") {
                        
                        array[1] = "\("Password:".localize())      " +  mal.replacingOccurrences(of: "P:", with: "", options: .literal, range: nil)
                    }
                    print(mal)
                }
            ...
            if let ar = text.components(separatedBy: ":")  as? NSArray {
                ...
                if ar.count > 1 {
                    ...
                    array[0] = "Phone Number".localize() + ": "  +  temp!
                }
                
                if ar.count > 2 {
                    let temp = ar[2] as? String
                    array[1] = "Body:".localize()  + " " + (temp ?? "")
                }
                
                if ar.count > 3 {
                    let temp = ar[3] as? String
                    array[2] = "Message:".localize() + " "   + (temp ?? "")
                }
